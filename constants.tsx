...
export const COMPANY_NAME = "CLICK GEOMAQUI REFRIGERAÇÃO";
export const COMPANY_ADDRESS = "LOJA 1 RUA MAIORCA 27 CAPÃO REDONDO";
export const COMPANY_ADDRESS_2 = "LOJA 2 RUA ARAIOAL DOS COUROS 603 JD SÃO LUIZ";
export const COMPANY_PHONES = "FONE 11 96157-0131 (SABRINA) / 11 96666-4740 (ROSIELE)";
export const WARRANTY_TEXT = "3 meses de garantia legal para peças e mão de obra.";
export const COMMISSION_RATE = 0.07; // 7% de comissão
...
export const ICONS = {
  ...
  Map: (props: any) => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.446 4.874-2.437c.381-.19.623-.579.623-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.252a1.125 1.125 0 0 0-1.006 0L3.622 5.689C3.24 5.88 3 6.27 3 6.695V19.18c0 .836.88 1.38 1.628 1.006l3.869-1.934c.317-.159.69-.159 1.006 0l4.994 2.497c.317.158.69.158 1.006 0Z" /></svg>,
  Download: (props: any) => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" /></svg>,
};
